//! Phase I: OEP-stealing prologue analyzer.
//!
//! Picks a prefix of the host PE's entry-point function and lifts
//! it into a heap trampoline so a memory dump captures `jmp <heap>`
//! at the OEP. Re-running the dump on a fresh process lands in
//! unmapped memory and crashes immediately.
//!
